...
const MyCall = (props) => {
    ...
    useEffect(() => {
        const callEvent = DeviceEventEmitter.addListener("offer", (data) => {
            //...
    ...
    useEffect(() => {
        const takeTheCall = DeviceEventEmitter.addListener("answer", (data) => {
    ...
    return <Container>
        {/* <BackHeader navigation={navigation} title="Cuộc gọi đến" onGoBack={handleGoBack} /> */}
...
export default compose(withConnect)(MyCall);