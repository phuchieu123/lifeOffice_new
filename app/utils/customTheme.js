...
const PRIMARY_COLOR = 'rgba(46, 149, 46, 1)';
const WARNING_COLOR = '#f0ad4e';
const INFO_COLOR = '#f0ad4e';
...
export default {
  ...
  brandInfo: INFO_COLOR,
  brandSuccess: '#5cb85c',
  brandDanger: DANGER_COLOR,
  brandWarning: WARNING_COLOR,
  brandDark: '#000',
  brandLight: '#a9a9a9',
  ...
  // Date Range Picker
  dateRangePickerColor: PRIMARY_COLOR,
  dateRangePickerTextColor: '#fff',
  get dateRangePickerArrowColor() {
    return this.dateRangePickerColor;
  },

  // FAB
  fabBackgroundColor: PRIMARY_COLOR,
  fabBorderRadius: 28,
  fabBottom: 0,
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? PRIMARY_COLOR : PRIMARY_COLOR,
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === '#b3c7f9',
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? PRIMARY_COLOR : '#fff',
  sTabBarActiveTextColor: PRIMARY_COLOR,
  tabBarActiveTextColor: platform === PLATFORM.IOS ? PRIMARY_COLOR : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : PRIMARY_COLOR,

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? PRIMARY_COLOR : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? PRIMARY_COLOR : PRIMARY_COLOR,
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 56,
  toolbarSearchIconSize: platform === PLATFORM.IOS ? 20 : 23,
  toolbarInputColor: platform === PLATFORM.IOS ? '#CECDD2' : '#fff',
  searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
  searchBarInputHeight: platform === PLATFORM.IOS ? 30 : 50,
  toolbarBtnTextColor: platform === PLATFORM.IOS ? PRIMARY_COLOR : '#fff',
  ...
  // Icon
  iconFamily: 'Ionicons',
  iconFontSize: platform === PLATFORM.IOS ? 30 : 24,
  ...
  listItemSelected: platform === PLATFORM.IOS ? PRIMARY_COLOR : PRIMARY_COLOR,
  ...
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? PRIMARY_COLOR : PRIMARY_COLOR,
  segmentTextColor: platform === PLATFORM.IOS ? PRIMARY_COLOR : PRIMARY_COLOR,
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : PRIMARY_COLOR,
  segmentBorderColor: platform === PLATFORM.IOS ? PRIMARY_COLOR : PRIMARY_COLOR,
